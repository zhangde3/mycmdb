...
if __name__ == '__main__':
    ...
    if args.host:
        ...
        server_csv = "server_list_%s_%s.csv" % (args.host, opt_time)
        vm_csv = "vm_list_%s_%s.csv" % (args.host, opt_time)
        ds_csv = "ds_list_%s_%s.csv" % (args.host, opt_time)
        license_csv = "license_list_%s_%s.csv" % (args.host, opt_time)

        to_csv(server_list,os.path.join(target_dir,server_csv))
        to_csv(vm_list,os.path.join(target_dir,vm_csv))
        to_csv(ds_list,os.path.join(target_dir,ds_csv))
        to_csv(license_list,os.path.join(target_dir,license_csv))